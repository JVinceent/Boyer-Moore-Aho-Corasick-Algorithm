...
# Component 5 — Performance Benchmarking (Updated for Multi-Column CSV)
# =============================================================================
...
# -----------------------------------------------------------------------------
# Paths (Updated to point to dict_large.csv)
# -----------------------------------------------------------------------------
DATASET_PATH = os.path.join(BASE_DIR, "data", "dict_large.csv")
...
# =============================================================================
# LOAD DICTIONARY (Updated for Multi-Column Format)
# =============================================================================
def load_dictionary(filepath: str) -> List[str]:
    """Load toxic terms from CSV including LeetSpeak variants."""
    if not PANDAS_AVAILABLE:
        return ["gago", "bobo", "tanga", "ulol", "puta", "idiot", "trash"]
    try:
        df = pd.read_csv(filepath)
        words = []
        # Extract from all relevant columns
